@parallel-tests @ruby-app @simplecov @disable-bundler
Feature: Parallel Tests Ruby App with SimpleCov
  ...
  Scenario: Parallel Tests Ruby App with SimpleCov
    Given I am working on the project "parallel_tests_ruby_app"
    And I use "with_simplecov.rb" as spec helper
    When I run specs using "parallel_rspec spec"
    Then The RSpecTracer should print the information
      ...
      """
    And The parallel processes information should have printed for 2 spec files
    ...
    And The JSON coverage report should have been generated for "ParallelTestsRSpec"
    And The coverage percent stat is "30 / 33 LOC (90.91%) covered"
    And The JSON coverage report should have correct coverage for "ParallelTestsRSpec"
    ...
    And The coverage percent stat is "30 / 33 LOC (90.91%) covered"
    And The JSON coverage report should have correct coverage for "ParallelTestsRSpec"
    When I run `bundle exec parallel_rspec spec/course_spec.rb`
    Then The RSpecTracer should print the information
      """
        Started RSpec tracer
        RSpec tracer is running 1 examples (actual: 2, skipped: 1)
        ...
        RSpec tracer merged parallel tests reports
      """
    And The parallel processes information should have printed for 1 spec files
    And The RSpecTracer report should have been generated
    And The last run report should have correct details
      """
      {
    ...
    When I run `bundle exec parallel_rspec spec/student_spec.rb`
    Then The RSpecTracer should print the information
      """
        Started RSpec tracer
        RSpec tracer is running 2 examples (actual: 8, skipped: 6)
