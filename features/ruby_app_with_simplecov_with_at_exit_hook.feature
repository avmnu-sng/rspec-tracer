@ruby-app @simplecov @at-exit-hook @disable-bundler
Feature: Ruby App with SimpleCov at-exit Hook
  ...
  Scenario: Ruby App with SimpleCov at-exit Hook
    Given I am working on the project "calculator_3_app"
    ...
    Then The RSpecTracer should print the information
      """
        ...
        Running SimpleCov exit task using at_exit hook
      """
    And The SimpleCov at_exit hook should have executed at the right time
    ...
    And The all files report should have correct details
      ...
      | /spec/spec_helper.rb      | 874f87a88c2401ad08a988c10e163bff  |
